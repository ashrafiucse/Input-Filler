...
import { describeField, detectType, isContentEditableEl, isComboboxDesc, isPrelineSelectDesc, isSecurityTokenField, resolveMediaProvider, mediaContext, wantsIntlPhone } from './detect';
...
function generateValue(
  ...
  switch (type) {
    ...
    case 'phone':
      return phone({ rng, intl: wantsIntlPhone(el, desc) });
    case 'street':
      return street(rng);
    case 'city':
      return city(rng);
